...
public class UserMovComAdapter extends RecyclerView.Adapter<UserMovComAdapter.ViewHolder>{
    private List<UserMovCom> movComslist;
    private Context context;
    public String user_id;
    private String session;
    private String id;

    public UserMovComAdapter(List<UserMovCom> list, String user_id, Context context){
        this.user_id = user_id;
        this.movComslist = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        final UserMovComAdapter.ViewHolder holder = new UserMovComAdapter.ViewHolder(view);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
            UserMovCom userMovCom = movComslist.get(i);
            id = userMovCom.getId();
            viewHolder.tv_movieTitle.setText(userMovCom.getFirmName());
            viewHolder.tv_time.setText(userMovCom.getTime());
            viewHolder.tv_content.setText(userMovCom.getContent());
    ...
    public int getItemCount() {
        if(null==movComslist) return 0;
        else return movComslist.size();
    }
